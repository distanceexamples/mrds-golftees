---
title: "Analysis of double observer survey"
author: "M. Louise Burt"
...
We see that the preferred model contains `distance + sex + exposure` so check the goodness-of-fit statistics and detection function plots. 
...
Determine if a simple point independence model is better than a simple full independence one. This requires that a distance sampling (DS) model is specified as well a MR model. Here we try a half-normal key function for the DS model. 

```{r pit-nocovar, fig.width=6}
